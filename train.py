...
from train_caption import train_caption
from train_video import train_image
...
def main():
    ...
    image_best_weight_list = [image_best_weight]
    dist.broadcast_object_list(image_best_weight_list, src=0)
    train_titles(args, image_best_weight_list[0])
    if dist.get_rank() == 0:
        fusion_scores()
