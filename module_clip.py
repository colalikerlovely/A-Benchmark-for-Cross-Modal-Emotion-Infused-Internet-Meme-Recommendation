...
class VisualTransformer(nn.Module):
    def __init__(self, input_resolution: int, patch_size: int, width: int, layers: int, heads: int, output_dim: int,
        ...
        self.input_resolution = input_resolution
        self.output_dim = output_dim
        # 改回来！！！！change in_channels=3 ->in_channels=4,
    ...
    def forward(self, x: torch.Tensor, video_frame=-1, return_dense=False):
        ...
        return x[:, 0, :]          # BS*T, 512 -----> embedding for each frame
...
class CLIP(nn.Module):
    def __init__(self,
        ...
        self.data_type = self.visual.conv1.weight.dtype
    ...
    def get_config(pretrained_clip_name):
        ...
        #root = '/ssd1/vis/wuwenhao/code/Research/workspace-video-retrival/CLIP-models'
        root = 'modules'
        # root = '/home/hpluo/lhp/Codes/PycharmCodes/Video-Text-Retrieval/CLIP-models'
        model_path = os.path.join(root, _PT_NAME[pretrained_clip_name])
    ...
    def encode_image(self, image, return_hidden=False, video_frame=-1):
        ...
        x = self.visual(image.type(self.dtype), video_frame=video_frame, return_dense=return_hidden)
